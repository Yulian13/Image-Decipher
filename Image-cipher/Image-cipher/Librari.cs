...
namespace Image_cipher
{
    public static class Librari
    {
       ...
       int keySize = 256)
        ...
        public static void MessadgeToConsole(ToolStripSplitButton Console, string messange)
        {
            Console.DropDownItems.Add(messange);
            Console.ForeColor = Color.GreenYellow;
        }
    }
}
